...
from GradTTS.model.dit_mocha import DiTMocha
# diffuser
...
class Concatenator:
    def __init__(self):
        pass
    def concatenate(self, inputs: list):
        pass
...
class CondDiffusion(BaseModule):
    ...
    def __init__(self,
                 ...
                 heads=4,
                 p_uncond=0.2,
                 estimator_type="dit",  # dit or unet,
    ...
    def reverse_diffusion(self,
        ...
        for i in range(n_timesteps):
            ...
            score_emo = score_emo.transpose(1, 2)
            ...
            if i in attn_img_time_ind:
                self_attns_list.append((i, attn_selfs))
                cross_attns_list.append((i, cross_attns_list))
    ...
    def loss_t(self,
        ...
        noise_estimation1 = noise_estimation * torch.sqrt(1.0 - torch.exp(-cum_noise))
        loss = torch.sum((noise_estimation1 + z) ** 2) / (torch.sum(mask) * self.n_feats)

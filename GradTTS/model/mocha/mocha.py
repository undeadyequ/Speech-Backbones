...
from GradTTS.model.mocha.headdrop import headdrop
from GradTTS.model.mocha.hma_train import parallel_monotonic_attention
from GradTTS.model.mocha.hma_test import hard_monotonic_attention
from GradTTS.model.mocha.mocha_train import soft_chunkwise_attention
from GradTTS.model.mocha.mocha_test import hard_chunkwise_attention
from GradTTS.model.mocha.chunk_energy import ChunkEnergy
from GradTTS.model.mocha.monotonic_energy import MonotonicEnergy
...
class MoChA(nn.Module):
    ...
    def forward(self, 
        ...
        if mode == 'parallel':  # training
            ...
            alpha, p_choose = hard_monotonic_attention(e_ma, aw_prev, eps_wait, self.p_threshold)  # [B, H_ma, qlen, klen]
            alpha_masked = alpha.clone()
        else:

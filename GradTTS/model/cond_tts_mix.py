...
class CondGradTTS(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, emo_emb_dim,
        ...
        if self.model_version == "vae":
            self.vqpe = VQProsodyEncoder
    ...
    def compute_loss(self,
        ...
        attn_for_test = torch.rand_like(attn)
        mon_attention_mask = create_mon_attn_mask(attn_uy=attn, attn_ref=attn_for_test)
        monAttn_loss = mon_attention_loss(attn, mon_attention_mask)

...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> hint = make_hint(watchImg, depth_estimator).unsqueeze(0).half().to("cuda")
        ...
        >>> img_emb = pipe_prior(prompt=prompt, image=watchImg, strength=0.85, generator=generator)
        >>> negative_emb = pipe_prior(prompt=negative_prior_prompt, image=watchImg, strength=1, generator=generator)
